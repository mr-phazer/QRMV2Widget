...
RMV2_Vertex_Common RMV2_Vertex_Raw_Cinematic::getCommon()
{
	RMV2_Vertex_Common o;
	
	o.position.x = pos_x;
	o.position.y = pos_y;
	o.position.z = pos_z;

	o.PVertex_Weights[0] = (float)weight1 / 255.0f;
	o.PVertex_Weights[1] = (float)weight2 / 255.0f;
	o.PVertex_Weights[2] = (float)weight3 / 255.0f;
	o.PVertex_Weights[3] = (float)weight4 / 255.0f;

	o.PBone_Ids[0] = joint_id1;
	o.PBone_Ids[1] = joint_id2;
	o.PBone_Ids[2] = joint_id3;
	o.PBone_Ids[3] = joint_id4;

	o.normal.x = lib3d::unorm8_to_float(norm_x);
	o.normal.y = lib3d::unorm8_to_float(norm_y);
	o.normal.z = lib3d::unorm8_to_float(norm_z);

	o.tangent.x = lib3d::unorm8_to_float(tangent_x);
	o.tangent.y = lib3d::unorm8_to_float(tangent_y);
	o.tangent.z = lib3d::unorm8_to_float(tangent_z);

	o.bitangent.x = lib3d::unorm8_to_float(bitangent_x);
	o.bitangent.y = lib3d::unorm8_to_float(bitangent_y);
	o.bitangent.z = lib3d::unorm8_to_float(bitangent_z);
